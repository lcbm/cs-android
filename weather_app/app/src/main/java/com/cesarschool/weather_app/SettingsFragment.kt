...
class SettingsFragment : Fragment() {
	...
	companion object {
		const val PREFS_SETTINGS =
			"PREFS_SETTINGS"
		const val PREFS_SETTINGS_TEMPERATURE_UNIT =
			"PREFS_SETTINGS_TEMPERATURE_UNIT"
		const val PREFS_SETTINGS_TEMPERATURE_UNIT_CELSIUS =
			"PREFS_SETTINGS_TEMPERATURE_UNIT_CELSIUS"
		const val PREFS_SETTINGS_TEMPERATURE_UNIT_FAHRENHEIT =
			"PREFS_SETTINGS_TEMPERATURE_UNIT_FAHRENHEIT"
		const val PREFS_SETTINGS_DESCRIPTION_LANGUAGE =
			"PREFS_SETTINGS_DESCRIPTION_LANGUAGE"
		const val PREFS_SETTINGS_DESCRIPTION_LANGUAGE_ENGLISH =
			"PREFS_SETTINGS_DESCRIPTION_LANGUAGE_ENGLISH"
		const val PREFS_SETTINGS_DESCRIPTION_LANGUAGE_PORTUGUESE =
			"PREFS_SETTINGS_DESCRIPTION_LANGUAGE_PORTUGUESE"
	}
